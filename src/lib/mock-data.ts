...
export const sentNotifications: SentNotification[] = [
  { id: "SN-001", titre: "Maintenance planifiée — 15 Juin", type: "MAINTENANCE", canaux: ["SMS", "PUSH"], audience: "ALL_USERS", audienceDetail: "23 847 utilisateurs actifs", message: "Cher utilisateur, une maintenance est planifiée le 15 juin de 02h à 05h GMT. Les services seront temporairement indisponibles. Merci de votre compréhension.", priorite: "HIGH", statut: "DELIVERED", nbDestinataires: 23847, nbDelivres: 23412, nbEchoues: 435, dateEnvoi: "2025-06-10 10:00", envoyePar: "Super Admin" },
  { id: "SN-002", titre: "Nouveaux plafonds KYC Tier 2", type: "KYC", canaux: ["SMS", "EMAIL"], audience: "ALL_USERS", audienceDetail: "8 320 utilisateurs Tier 2", message: "Bonne nouvelle ! Vos plafonds ont été augmentés : Dépôt 5M XOF/mois, Retrait 1.5M XOF/mois. Vérifiez votre espace pour plus de détails.", priorite: "NORMAL", statut: "DELIVERED", nbDestinataires: 8320, nbDelivres: 8156, nbEchoues: 164, dateEnvoi: "2025-06-10 09:00", envoyePar: "Admin Conformité" },
  { id: "SN-003", titre: "Rechargement Float — Action requise", type: "SYSTEM", canaux: ["SMS"], audience: "ALL_AGENTS", audienceDetail: "1 245 agents actifs", message: "Votre float est inférieur au seuil minimum. Veuillez procéder à un rechargement pour continuer à offrir le service dépôt/retrait.", priorite: "URGENT", statut: "PARTIAL", nbDestinataires: 1245, nbDelivres: 1189, nbEchoues: 56, dateEnvoi: "2025-06-09 14:30", envoyePar: "Admin Financier" },
  { id: "SN-004", titre: "Alerte Sécurité — Vérification requise", type: "SECURITY", canaux: ["SMS", "EMAIL", "PUSH"], audience: "SPECIFIC_USERS", audienceDetail: "12 utilisateurs concernés", message: "Nous avons détecté une activité suspecte sur votre compte. Pour votre sécurité, veuillez vérifier vos dernières transactions et changer votre code secret.", priorite: "URGENT", statut: "DELIVERED", nbDestinataires: 12, nbDelivres: 12, nbEchoues: 0, dateEnvoi: "2025-06-09 11:15", envoyePar: "Super Admin" },
  { id: "SN-005", titre: "Promo — 0% frais de transfert ce week-end", type: "PROMOTION", canaux: ["SMS", "PUSH"], audience: "ALL_USERS", audienceDetail: "23 847 utilisateurs actifs", message: "🎉 Ce week-end, envoyez de l'argent gratuitement ! 0% de frais sur tous les transferts du samedi 7h au dimanche 23h.", priorite: "NORMAL", statut: "DELIVERED", nbDestinataires: 23847, nbDelivres: 22015, nbEchoues: 1832, dateEnvoi: "2025-06-08 08:00", envoyePar: "Admin Reporting" },
  { id: "SN-006", titre: "Rappel KYC — Complétez votre vérification", type: "KYC", canaux: ["SMS"], audience: "SPECIFIC_USERS", audienceDetail: "3 450 utilisateurs Tier 0", message: "Complétez votre vérification KYC pour bénéficier de plafonds plus élevés. Soumettez votre pièce d'identité directement dans l'app.", priorite: "NORMAL", statut: "PARTIAL", nbDestinataires: 3450, nbDelivres: 3201, nbEchoues: 249, dateEnvoi: "2025-06-08 16:00", envoyePar: "Admin Conformité" },
  { id: "SN-007", titre: "Nouveau partenaire — Orange Money", type: "SYSTEM", canaux: ["EMAIL", "PUSH"], audience: "ALL_AGENTS", audienceDetail: "1 245 agents actifs", message: "Orange Money Mali est maintenant intégré ! Vous pouvez désormais effectuer des cash-in/cash-out Orange Money. Formation disponible dans l'espace agent.", priorite: "HIGH", statut: "DELIVERED", nbDestinataires: 1245, nbDelivres: 1230, nbEchoues: 15, dateEnvoi: "2025-06-07 10:30", envoyePar: "Admin Support" },
  { id: "SN-008", titre: "Incident technique résolu", type: "MAINTENANCE", canaux: ["PUSH"], audience: "ALL", audienceDetail: "Tous les utilisateurs et agents", message: "L'incident technique sur les paiements par QR code est résolu. Tous les services sont de nouveau opérationnels. Merci pour votre patience.", priorite: "HIGH", statut: "DELIVERED", nbDestinataires: 25092, nbDelivres: 24800, nbEchoues: 292, dateEnvoi: "2025-06-07 18:45", envoyePar: "Super Admin" },
  { id: "SN-009", titre: "Rapport hebdomadaire disponible", type: "SYSTEM", canaux: ["EMAIL"], audience: "ALL_AGENTS", audienceDetail: "1 245 agents actifs", message: "Votre rapport hebdomadaire est disponible : volume de transactions, commissions gagnées et performances. Consultez-le dans votre espace.", priorite: "NORMAL", statut: "PARTIAL", nbDestinataires: 1245, nbDelivres: 1198, nbEchoues: 47, dateEnvoi: "2025-06-06 07:00", envoyePar: "Admin Reporting" },
  { id: "SN-010", titre: "Alerte Fraude — Suspicion de compte compromis", type: "SECURITY", canaux: ["SMS", "EMAIL", "PUSH"], audience: "SPECIFIC_USERS", audienceDetail: "5 utilisateurs signalés", message: "Alerte de sécurité : des transactions inhabituelles ont été détectées sur votre compte. Votre accès a été temporairement restreint. Contactez le support au 80 00 00 00.", priorite: "URGENT", statut: "DELIVERED", nbDestinataires: 5, nbDelivres: 5, nbEchoues: 0, dateEnvoi: "2025-06-05 22:30", envoyePar: "Super Admin" },
  { id: "SN-011", titre: "Mise à jour CGU — Nouvelles conditions", type: "SYSTEM", canaux: ["EMAIL"], audience: "ALL_USERS", audienceDetail: "23 847 utilisateurs actifs", message: "Nos conditions générales d'utilisation ont été mises à jour. Consultez les nouvelles conditions sur votre espace. Elles entrent en vigueur le 1er juillet 2025.", priorite: "NORMAL", statut: "DELIVERED", nbDestinataires: 23847, nbDelivres: 23200, nbEchoues: 647, dateEnvoi: "2025-06-04 09:00", envoyePar: "Admin Juridique" },
  { id: "SN-012", titre: "Formation obligatoire — Lutte anti-blanchiment", type: "KYC", canaux: ["EMAIL", "PUSH"], audience: "ALL_AGENTS", audienceDetail: "1 245 agents actifs", message: "Une formation obligatoire sur la lutte anti-blanchiment est disponible. Tous les agents doivent la compléter avant le 30 juin 2025.", priorite: "HIGH", statut: "DELIVERED", nbDestinataires: 1245, nbDelivres: 1210, nbEchoues: 35, dateEnvoi: "2025-06-03 08:00", envoyePar: "Admin Conformité" },
  { id: "SN-013", titre: "Promo été — Cashback 5% sur paiements", type: "PROMOTION", canaux: ["SMS", "EMAIL", "PUSH"], audience: "ALL_USERS", audienceDetail: "23 847 utilisateurs actifs", message: "☀️ Profitez de 5% de cashback sur tous vos paiements marchands cet été ! Offre valable du 15 juin au 31 août 2025.", priorite: "NORMAL", statut: "DELIVERED", nbDestinataires: 23847, nbDelivres: 22890, nbEchoues: 957, dateEnvoi: "2025-06-02 10:00", envoyePar: "Admin Marketing" },
  { id: "SN-014", titre: "Maintenance d'urgence — Résolution", type: "MAINTENANCE", canaux: ["SMS", "PUSH"], audience: "ALL", audienceDetail: "Tous les utilisateurs et agents", message: "La maintenance d'urgence est terminée. Tous les services sont rétablis. Nous nous excusons pour la gêne occasionnée.", priorite: "URGENT", statut: "DELIVERED", nbDestinataires: 25092, nbDelivres: 24950, nbEchoues: 142, dateEnvoi: "2025-06-01 03:15", envoyePar: "Super Admin" },
  { id: "SN-015", titre: "Rappel — Solde inactif depuis 90 jours", type: "SYSTEM", canaux: ["SMS"], audience: "SPECIFIC_USERS", audienceDetail: "2 150 utilisateurs inactifs", message: "Votre compte n'a pas été utilisé depuis 90 jours. Pour éviter la désactivation, connectez-vous ou effectuez une transaction.", priorite: "NORMAL", statut: "PARTIAL", nbDestinataires: 2150, nbDelivres: 1980, nbEchoues: 170, dateEnvoi: "2025-05-31 14:00", envoyePar: "Admin Support" },
  { id: "SN-016", titre: "Confirmation virement international", type: "TRANSACTION", canaux: ["EMAIL"], audience: "SPECIFIC_USERS", audienceDetail: "45 utilisateurs concernés", message: "Votre virement international a été traité avec succès. Le bénéficiaire recevra les fonds sous 24-48h ouvrées.", priorite: "NORMAL", statut: "DELIVERED", nbDestinataires: 45, nbDelivres: 45, nbEchoues: 0, dateEnvoi: "2025-05-30 11:00", envoyePar: "Admin Financier" },
  { id: "SN-017", titre: "Nouvelle version app disponible", type: "SYSTEM", canaux: ["PUSH"], audience: "ALL_USERS", audienceDetail: "23 847 utilisateurs actifs", message: "Une nouvelle version de l'application est disponible ! Mettez à jour pour profiter des dernières fonctionnalités et corrections.", priorite: "NORMAL", statut: "PARTIAL", nbDestinataires: 23847, nbDelivres: 18900, nbEchoues: 4947, dateEnvoi: "2025-05-29 09:30", envoyePar: "Admin Technique" },
  { id: "SN-018", titre: "Alerte — Tentative de connexion suspecte", type: "SECURITY", canaux: ["SMS", "EMAIL"], audience: "SPECIFIC_USERS", audienceDetail: "8 utilisateurs concernés", message: "Une tentative de connexion depuis un appareil non reconnu a été détectée. Si ce n'est pas vous, changez immédiatement votre code secret.", priorite: "URGENT", statut: "DELIVERED", nbDestinataires: 8, nbDelivres: 8, nbEchoues: 0, dateEnvoi: "2025-05-28 16:45", envoyePar: "Super Admin" },
  { id: "SN-019", titre: "Commision exceptionnelle — Bonus agents", type: "PROMOTION", canaux: ["SMS", "EMAIL"], audience: "ALL_AGENTS", audienceDetail: "1 245 agents actifs", message: "🎁 Bonus exceptionnel ! Commissions majorées de 20% sur toutes les transactions du 1er au 15 juin. Profitez-en !", priorite: "HIGH", statut: "DELIVERED", nbDestinataires: 1245, nbDelivres: 1225, nbEchoues: 20, dateEnvoi: "2025-05-28 08:00", envoyePar: "Admin Financier" },
  { id: "SN-020", titre: "Clôture bureau — Jour férié", type: "SYSTEM", canaux: ["EMAIL"], audience: "ALL_AGENTS", audienceDetail: "1 245 agents actifs", message: "Rappel : le bureau sera fermé le 26 mai pour le jour férié. Les opérations reprendront le 27 mai à 8h.", priorite: "NORMAL", statut: "FAILED", nbDestinataires: 1245, nbDelivres: 890, nbEchoues: 355, dateEnvoi: "2025-05-25 15:00", envoyePar: "Admin Support" },
]
